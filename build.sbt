...
libraryDependencies ++= Seq(
  //LOGGING
    ...
    //SPRAY
    "cc.spray" % "spray-routing" % "1.0-M3-SNAPSHOT-20120914" % "compile" withSources(),
    "cc.spray" % "spray-http" % "1.0-M3-SNAPSHOT-20120914" % "compile" withSources(),
    "cc.spray" % "spray-can" % "1.0-M3-SNAPSHOT-20120914" % "compile" withSources(),
    "cc.spray" % "spray-io" % "1.0-M3-SNAPSHOT-20120914" % "compile" withSources(),
    "cc.spray" % "spray-caching" % "1.0-M3-SNAPSHOT-20120914" % "compile" withSources(),
    //AKKA
